...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <a href="{{ route('dashboard.group.create') }}" class="btn btn-primary mb-4 mt-2">
                <i class="fas fa-plus me-2"></i> Tambah Data
            </a>

            <div class="table-responsive">
                <table id="groups" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th class="text-left" style="width: 5% !important;">No</th>
                            <th class="text-left">No Kelas</th>
            ...
            let dataTable = $('#groups').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            return `
                                <a href="{{ url('/dashboard/group/${full.id}/edit') }}">
                                    <button type="button" class="btn btn-primary btn-sm"><i class="fas fa-pen-square me-2"></i>Edit</button>
                                </a>
                                <form action="{{ url('/dashboard/group/${full.id}') }}" style="display: inline;" method="POST">
                                    @csrf
                                    @method('DELETE')
