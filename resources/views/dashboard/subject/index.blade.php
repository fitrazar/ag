...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <a href="{{ route('dashboard.subject.create') }}" class="btn btn-primary mb-4 mt-2">
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            return `
                                <a href="{{ url('/dashboard/subject/${full.id}/edit') }}">
                                    <button type="button" class="btn btn-primary btn-sm"><i class="fas fa-pen-square me-2"></i>Edit</button>
                                </a>
                                <form action="{{ url('/dashboard/subject/${full.id}') }}" style="display: inline;" method="POST">
                                    @csrf
                                    @method('DELETE')
