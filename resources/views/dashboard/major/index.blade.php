...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <a href="{{ route('dashboard.major.create') }}" class="btn btn-primary mb-4 mt-2">
                <i class="fas fa-plus me-2"></i> Tambah Data
            </a>

            <div class="table-responsive">
                <table id="majors" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            let dataTable = $('#majors').DataTable({
                buttons: [
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            return `
                                <a href="{{ url('/dashboard/major/${full.id}/edit') }}">
                                    <button type="button" class="btn btn-primary btn-sm"><i class="fas fa-pen-square me-2"></i>Edit</button>
                                </a>
                                <form action="{{ url('/dashboard/major/${full.id}') }}" style="display: inline;" method="POST">
                                    @csrf
                                    @method('DELETE')
