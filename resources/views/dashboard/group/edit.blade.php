...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form class="row g-3 p-2" action="{{ route('dashboard.group.update', $group->id) }}" method="POST"
                ...
                <div class="col-6 mb-3">
                    ...
                    <input type="number" class="form-control @error('number') is-invalid @enderror" id="number"
                        name="number" value="{{ old('number', $group->number) }}" required>
                    @error('number')
                ...
                {{-- <div class="form-check col-12 mb-3">
                    <input class="form-check-input" type="checkbox"
                        {{ old('status', $group->status) == true ? ' ' : ' checked' }} id="status" name="status">
